...
const Post = ({
  ...
  return (
      <>
      {post && post.postedBy && ( <div key={post._id} className="card my-3">
    ...
    <div className="d-flex">
        ...
        <>
            ...
            className="text-danger pt-2 h5 ml-5 "
            />
        </>
        )}
    </div>
    ...
    <ol className="list-group" style={{maxHeight:'125px', overflow:'scroll'}}>
        ...
        <li key={c._id} className="list-group-item d-flex justify-content-between align-items-start">
            ...
            <div className='ml-auto mt-1'>
                <DeleteOutlined onClick={()=>removeComment(post._id,c)} className='pl-2 text-danger h5' />
            </div>    
            )   }
            </span>
        </li> 
